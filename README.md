...
A public source repository for nine orthogonal engineering Skills plus a separate **content catalog**. The engineering nine stay exclusive (four state-owning governance Skills, one closed-loop decision advisor, three artifact-owning role Skills, and one documentation-authoring Skill). Content Skills live under `skills/content/` and are **not** counted against that engineering cap.
